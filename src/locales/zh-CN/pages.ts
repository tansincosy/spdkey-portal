export default {
  ...
  'pages.searchTable.nameStatus.default': '默认',
  ...
  'pages.searchTable.add.sourceAdd': '选择频道源',
  'pages.channel.table.list.chosenChannel': '所有频道源',
  'pages.channel.table.list.url': 'm3u地址',
  'pages.channel.table.list.input-url': '请输入m3u地址',
  'pages.channel.form.add.success.message': '新建频道成功',
  'pages.channel.form.del.success': '删除频道成功',
  'pages.channel.form.del.fail': '删除频道失败',
  'pages.channel.form.del.is-del': '是否确认删除？',
  'pages.searchTable.nameStatus.yes': '是',
  'pages.searchTable.nameStatus.no': '否',
